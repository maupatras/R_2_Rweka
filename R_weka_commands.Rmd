...
#### Επιπλέον εξετάζεται η διαδικασία ενημέρωσης του χρήση για τις διαθέσιμες επιλογές των ταξινομητών και των διάφορων στοιχείων του Weka
```{r, echo=TRUE}
...
#### Στη συνέχεια παρουσιάζεται η διαδικασία κλήσης και χρήση των φίλτρων του Weka
```{r, echo=TRUE}
...
#### Τέλος, αξίζει να αναφερθεί πως παέχεται η δυνατότητα δημιουργίας διεπαφών από τον ίδιο το χρήση προα αντικέιμενα του Weka
```{r, echo=TRUE}
